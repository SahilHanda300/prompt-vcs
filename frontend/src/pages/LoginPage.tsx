      ...
      <div className="flex-1 flex items-center justify-center px-4">
        <div className="w-full max-w-sm">
          ...
          <div className="bg-white dark:bg-slate-800/60 border border-gray-200 dark:border-slate-700 rounded-2xl p-8 shadow-sm">
            <h1 className="text-xl font-bold text-gray-900 dark:text-white text-center mb-1">Welcome back</h1>
            <p className="text-sm text-gray-400 dark:text-slate-500 text-center mb-6">Sign in to your PromptVCS account</p>
